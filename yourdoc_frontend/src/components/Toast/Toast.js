...
export function Toast({ type = 'success', title, text }) {
  const typeValueMap = {
    danger: {
    ...
    <div
      ...
      <div
        ...
        <div className="flex items-center">
          <p className="text-xs text-success-700">just now</p>
          <button
            type="button"
      ...
      <div
        className="break-words rounded-b-lg bg-success-100 py-4 px-4 text-success-700">
        {text}
      </div>
    </div>
