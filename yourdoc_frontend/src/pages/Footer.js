    ...
    <footer className="text-center bg-gray-800 text-white">
      <div className="container px-6 pt-6">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2">
          <div className="mb-6">
            <h5 className="uppercase font-bold mb-2.5">CEO</h5>
            <p className="text-white">Dr Harshita Sharma</p>
          </div>

          <div className="mb-6">
            <h5 className="uppercase font-bold mb-2.5">Email</h5>
            <p className="text-white">yourdoc@gmail.com</p>
          </div>

          <div className="mb-6">
            <h5 className="uppercase font-bold mb-2.5">Phone</h5>
            <p className="text-white">92244556678</p>
          </div>

          <div className="mb-6">
            <h5 className="uppercase font-bold mb-2.5">Location</h5>
            <p className="text-white">Halifax, Nova Scotia</p>
          </div>
        </div>
      </div>

      <div className="text-center p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}}>
        © 2023 Copyright: yourdoc@gmail.com
      </div>
    </footer>
